    ...
    return (
      <>
        ...
        <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-50 p-8 ml-64">
          ...
          <div className="mb-8">
            <h1 className="text-4xl font-bold text-slate-900 mb-2">AI Сбор семантики</h1>
            <p className="text-lg text-slate-600">Создайте проект для кластеризации ключевых слов</p>
          </div>
          ...
          <Card className="p-12 text-center">
            <div className="max-w-md mx-auto space-y-6">
              <div className="w-24 h-24 bg-gradient-to-br from-blue-100 to-indigo-100 rounded-full flex items-center justify-center mx-auto">
                <Icon name="FolderPlus" className="h-12 w-12 text-blue-600" />
              </div>
              <div>
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 bg-gradient-to-br from-blue-100 to-indigo-100 rounded-lg flex items-center justify-center">
                    <Icon name="Folder" className="h-6 w-6 text-blue-600" />
                  </div>
                  <div>
